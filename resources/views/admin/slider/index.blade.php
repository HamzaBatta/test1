...
@section('content')
   ...
   <a href="{{ route('sliders.edit', $slider->id) }}"
                                        ...
                                        @endcan
                                                 ...
                                                 <a class="btn btn-sm  btn-success " href="{{ route('sliders.show',$slider->id) }}">{{trans('app.show')}}</a>
                                            @can('slider-delete')

                                         <button class=" btn btn-sm btn-danger openModal" id='{{ "openModal".$slider->id }}' onclick='{{ "runme(openModal".$slider->id.")" }}' >{{trans('app.delete')}}</button>


                                        <div class=" modal" id='{{ "m_openModal".$slider->id }}'>
                                        <div class="modalContent">
                                        <span class="close" onclick='{{ "hideme(openModal".$slider->id.")" }}' id='{{ "c_openModal".$slider->id }}'>×</span>
                                        ...
                                        <button class="del" onclick='{{ "hideme(openModal".$slider->id.")" }}'>{{trans('app.delete')}}</button>
                                        {!! Form::close() !!}
                                        <button class="cancel" onclick='{{ "hideme(openModal".$slider->id.")" }}'>{{trans('app.cancel')}}</button>
                                            @endcan
                                        </div>
                                        </div>
                                        </div>
