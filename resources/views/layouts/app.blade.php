...
<body >
        ...
        <div class="sidebar-heading">{{trans('app.Course')}} </div>
        <div class="list-group list-group-flush">
            ...
            <a href="{{ route('galleries.index') }}" class="list-group-item list-group-item-action bg-light">{{(trans('app.Gallery')) }}</a>

            <a href="{{ route('sliders.index') }}" class="list-group-item list-group-item-action bg-light">{{trans('app.Slider') }}</a>

            <a href="{{ route('abouts.index') }}" class="list-group-item list-group-item-action bg-light">{{trans('app.Abouts') }}</a>

            <a href="{{ route('roles.index') }}" class="list-group-item list-group-item-action bg-light">{{trans('app.Role') }}</a>

            <a href="{{ route('users.index') }}" class="list-group-item list-group-item-action bg-light">{{trans('app.User') }}</a>
